...
import static lk.ijse.controller.Client3LoginFormController.*;

public class Client3ChatFormController extends Thread implements Initializable {
    ...
    public void btnAddOnAction() {
        //OpenView.openView("client3LoginForm");
    }
